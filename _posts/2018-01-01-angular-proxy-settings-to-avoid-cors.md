...
{% highlight wl linenos %} { "/api": { "target": "http://localhost:8080", "secure": false } } {% endhighlight %}

run ng serve with a configuration file.\
{% highlight wl linenos %} ng serve --proxy-config proxy.config.json {% endhighlight %}
