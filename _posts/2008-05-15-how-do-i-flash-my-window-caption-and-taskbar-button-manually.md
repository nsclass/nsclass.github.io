...
Commenter Jonathan Scheepers [wonders about those programs that flash their taskbar button indefinitely](http://blogs.msdn.com/oldnewthing/pages/407234.aspx#513263), overriding the default flash count set by `SysteParametersInfo(SPI_SETFOREGROUNDFLASHCOUNT)`.
