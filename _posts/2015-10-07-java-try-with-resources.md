...
{% highlight wl linenos %} using (var socket = new Socket(...)) { } {% endhighlight %}
...
{% highlight wl linenos %} try ( File file = new FileInputStream(...); File output = new FileInputStream(...); ) { } {% endhighlight %}
