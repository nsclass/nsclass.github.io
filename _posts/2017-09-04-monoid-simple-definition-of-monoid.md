...
Integer plus:\
{% highlight wl linenos %} 1 + 2 = 3 (1 + 2) + 3 = 1 + (2 + 3) 1 + 0 = 1 0 + 1 = 1 {% endhighlight %}

String concatenation:\
{% highlight wl linenos %} "1" + "2" = "12" "1" + ("2" + "3") = ("1" + "2") + "3" "" + "1" = "1" "1" + "" = "1" {% endhighlight %}
...
Map/Reduce\
{% highlight wl linenos %} List.reduce(+) {% endhighlight %}
